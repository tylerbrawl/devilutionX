...
UiItem MAINMENU_DIALOG[] = {
	MAINMENU_BACKGROUND,
	MAINMENU_LOGO,
	UiList(MAINMENU_DIALOG_ITEMS, PANEL_LEFT + 64, (int) (SCREEN_HEIGHT / 2.5f), 510, 43, UIS_HUGE | UIS_GOLD | UIS_CENTER),
	UiArtText(NULL, { 17, (SCREEN_HEIGHT - 36), 605, 21 }, UIS_SMALL)
};
