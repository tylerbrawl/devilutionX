...
UiItem SELOK_DIALOG[] = {
	MAINMENU_BACKGROUND,
	MAINMENU_LOGO,
	UiArtText(selok_title, { PANEL_LEFT + 24, (MAINMENU_BACKGROUND_Y + 161), 590, 35 }, UIS_CENTER | UIS_BIG),
	UiArtText(dialogText, { PANEL_LEFT + 140, (MAINMENU_BACKGROUND_Y + 210), 560, 168 }, UIS_MED),
	UiList(SELOK_DIALOG_ITEMS, PANEL_LEFT + 230, (MAINMENU_BACKGROUND_Y + 390), 180, 35, UIS_CENTER | UIS_BIG | UIS_GOLD)
};

UiItem SPAWNERR_DIALOG[] = {
	MAINMENU_BACKGROUND,
	MAINMENU_LOGO,
	UiArtText(dialogText, { PANEL_LEFT + 140, (MAINMENU_BACKGROUND_Y + 197), 560, 168 }, UIS_MED),
	UiList(SELOK_DIALOG_ITEMS, PANEL_LEFT + 230, (MAINMENU_BACKGROUND_Y + 390), 180, 35, UIS_CENTER | UIS_BIG | UIS_GOLD)
};
