...
UiItem SELHERO_DIALOG[] = {
	MAINMENU_BACKGROUND,
	MAINMENU_LOGO,
	UiArtText(title, { PANEL_LEFT + 24, (MAINMENU_BACKGROUND_Y + 161), 590, 35 }, UIS_CENTER | UIS_BIG),
	UiImage(&ArtHero, UI_NUM_CLASSES, { PANEL_LEFT + 30, (MAINMENU_BACKGROUND_Y + 211), 180, 76 }),
	UiArtText("Level:", { PANEL_LEFT + 39, (MAINMENU_BACKGROUND_Y + 323), 110, 21 }, UIS_RIGHT),
	UiArtText(textStats[0], { PANEL_LEFT + 159, (MAINMENU_BACKGROUND_Y + 323), 40, 21 }, UIS_CENTER),
	UiArtText("Strength:", { PANEL_LEFT + 39, (MAINMENU_BACKGROUND_Y + 358), 110, 21 }, UIS_RIGHT),
	UiArtText(textStats[1], { PANEL_LEFT + 159, (MAINMENU_BACKGROUND_Y + 358), 40, 21 }, UIS_CENTER),
	UiArtText("Magic:", { PANEL_LEFT + 39, (MAINMENU_BACKGROUND_Y + 380), 110, 21 }, UIS_RIGHT),
	UiArtText(textStats[2], { PANEL_LEFT + 159, (MAINMENU_BACKGROUND_Y + 380), 40, 21 }, UIS_CENTER),
	UiArtText("Dexterity:", { PANEL_LEFT + 39, (MAINMENU_BACKGROUND_Y + 401), 110, 21 }, UIS_RIGHT),
	UiArtText(textStats[3], { PANEL_LEFT + 159, (MAINMENU_BACKGROUND_Y + 401), 40, 21 }, UIS_CENTER),
	UiArtText("Vitality:", { PANEL_LEFT + 39, (MAINMENU_BACKGROUND_Y + 422), 110, 21 }, UIS_RIGHT),
	UiArtText(textStats[4], { PANEL_LEFT + 159, (MAINMENU_BACKGROUND_Y + 422), 40, 21 }, UIS_CENTER),
};
...
UiItem SELLIST_DIALOG[] = {
	UiArtText("Select Hero", { PANEL_LEFT + 264, (MAINMENU_BACKGROUND_Y + 211), 320, 33 }, UIS_CENTER | UIS_BIG),
	UiList(SELLIST_DIALOG_ITEMS, PANEL_LEFT + 265, (MAINMENU_BACKGROUND_Y + 256), 320, 26, UIS_CENTER | UIS_MED | UIS_GOLD),
	MakeScrollBar({ PANEL_LEFT + 585, (MAINMENU_BACKGROUND_Y + 244), 25, 178 }),
	UiArtTextButton("OK", &UiFocusNavigationSelect, { PANEL_LEFT + 239, (MAINMENU_BACKGROUND_Y + 429), 120, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD),
	UiArtTextButton("Delete", &selhero_UiFocusNavigationYesNo, { PANEL_LEFT + 364, (MAINMENU_BACKGROUND_Y + 429), 120, 35 }, UIS_CENTER | UIS_BIG | UIS_DISABLED),
	UiArtTextButton("Cancel", &UiFocusNavigationEsc, { PANEL_LEFT + 489, (MAINMENU_BACKGROUND_Y + 429), 120, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD)
};
...
UiItem SELCLASS_DIALOG[] = {
	UiArtText("Choose Class", { PANEL_LEFT + 264, (MAINMENU_BACKGROUND_Y + 211), 320, 33 }, UIS_CENTER | UIS_BIG),
	UiList(SELCLAS_DIALOG_ITEMS, PANEL_LEFT + 264, (MAINMENU_BACKGROUND_Y + 285), 320, 33, UIS_CENTER | UIS_MED | UIS_GOLD),
	UiArtTextButton("OK", &UiFocusNavigationSelect, { PANEL_LEFT + 279, (MAINMENU_BACKGROUND_Y + 429), 140, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD),
	UiArtTextButton("Cancel", &UiFocusNavigationEsc, { PANEL_LEFT + 429, (MAINMENU_BACKGROUND_Y + 429), 140, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD)
};

UiItem ENTERNAME_DIALOG[] = {
	UiArtText("Enter Name", { PANEL_LEFT + 264, (MAINMENU_BACKGROUND_Y + 211), 320, 33 }, UIS_CENTER | UIS_BIG),
	UiEdit(selhero_heroInfo.name, 15, { PANEL_LEFT + 265, (MAINMENU_BACKGROUND_Y + 317), 320, 33 }, UIS_MED | UIS_GOLD),
	UiArtTextButton("OK", &UiFocusNavigationSelect, { PANEL_LEFT + 279, (MAINMENU_BACKGROUND_Y + 429), 140, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD),
	UiArtTextButton("Cancel", &UiFocusNavigationEsc, { PANEL_LEFT + 429, (MAINMENU_BACKGROUND_Y + 429), 140, 35 }, UIS_CENTER | UIS_BIG | UIS_GOLD)
};
...
UiItem SELLOAD_DIALOG[] = {
	UiArtText("Save File Exists", { PANEL_LEFT + 264, (MAINMENU_BACKGROUND_Y + 211), 320, 33 }, UIS_CENTER | UIS_BIG),
	UiList(SELLOAD_DIALOG_ITEMS, PANEL_LEFT + 265, (MAINMENU_BACKGROUND_Y + 285), 320, 33, UIS_CENTER | UIS_MED | UIS_GOLD),
	UiArtTextButton("OK", &UiFocusNavigationSelect, { PANEL_LEFT + 279, (MAINMENU_BACKGROUND_Y + 427), 140, 35 }, UIS_CENTER | UIS_VCENTER | UIS_BIG | UIS_GOLD),
	UiArtTextButton("Cancel", &UiFocusNavigationEsc, { PANEL_LEFT + 429, (MAINMENU_BACKGROUND_Y + 427), 140, 35 }, UIS_CENTER | UIS_VCENTER | UIS_BIG | UIS_GOLD)
};
